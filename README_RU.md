...
2. **Настройка устройства:**
   ...
   - **Crypto Name:** Криптовалюта устройства, например, "Solana" или "Toncoin". Вы можете опционально добавить в это поле GPIO пины. Пример: `Solana:12,11,22`, где Solana — это криптовалюта устройсва, а `12,11,22` — это соответствующие номера пинов для реле, кнопка сброса и светодиода (`RELAY_PIN,BUTTON_PIN,LED_PIN`).
